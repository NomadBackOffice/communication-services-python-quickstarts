...
COGNITIVE_SERVICE_ENDPOINT="AZURE_AI_SEARCH_ENDPOINT"

# Cognitive service endpoint
AZURE_OPENAI_SERVICE_KEY = "AZURE_AI_SEARCH_KEY"

# Open AI service endpoint
AZURE_OPENAI_SERVICE_ENDPOINT="OPENAI_ENDPOINT"

# Azure Open AI Deployment Model Name
AZURE_OPENAI_DEPLOYMENT_MODEL_NAME="OPENAI_DEPLOYMENT_MODEL_NAME"
